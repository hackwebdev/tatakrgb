<body>
  ...
  <header>
    <a href="#" class="logo"><i class="fas fa-utensils" />resto.</a>
    ...
    <div class="row">
      ...
      <div class="content">
        ...
        <p>
          ...
          corrupti corporis quaerat voluptatem ipsam neque labore modi autem,
          saepe numquam quod reprehenderit rem? Tempora aut soluta odio corporis
          nihil!
        </p>
        <p>
